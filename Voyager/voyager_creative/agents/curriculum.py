...
from voyager_creative.utils.json_utils import fix_and_parse_json
from langchain.schema import HumanMessage, SystemMessage
from langchain_chroma import Chroma
from .llm_wrapper import ChatWrapper
from .embed_wrapper import EmbeddingWrapper
...
class CurriculumAgent:
    def __init__(
        ...
        self.qa_cache_questions_vectordb = Chroma(
            ...
            embedding_function=EmbeddingWrapper("gemini"),
    ...
    def propose_next_ai_task(self, *, messages, max_retries=5):
        ...
        curriculum = self.llm.chat(messages).content
    ...
    def run_qa(self, *, events, chest_observation):
        ...
        for question in questions_new:
            ...
            if question in self.qa_cache:
                print(f"\033[31mWarning: Question already exists in cache: {question}")
            else:
    ...
    def run_qa_step1_ask_questions(self, *, events, chest_observation):
        ...
        qa_response = self.qa_llm.chat(messages).content
        try:
    ...
    def run_qa_step2_answer_questions(self, question):
        ...
        qa_answer = self.qa_llm.chat(messages).content
