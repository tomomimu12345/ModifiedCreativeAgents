...
from voyager_creative.control_primitives import load_control_primitives
...
class SkillManager:
    def __init__(
        ...
        self.control_primitives = load_control_primitives(use_command=use_command)
    ...
    def generate_skill_description(self, program_name, program_code):
        ...
        skill_description = f"    // { self.llm.chat(messages).content}"
    ...
    def retrieve_skills(self, query):
        ...
        docs_and_scores = self.vectordb.similarity_search_with_score(query, k=k) # similarity
        print(
