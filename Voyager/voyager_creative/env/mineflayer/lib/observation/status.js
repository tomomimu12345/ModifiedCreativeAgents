...
class Status extends Observation {
    ...
    observe() {
        const mcData = require("../../node_modules/minecraft-data")(this.bot.version);
        let biome_ = this.bot.blockAt(this.bot.entity.position)? this.bot.blockAt(this.bot.entity.position).biome: "None";
        ...
        return {
            ...
            biome: mcData.biomes[biome_.id].name,
