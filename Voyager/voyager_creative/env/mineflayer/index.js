...
const OnPlace = require("./lib/observation/onPlace");
...
req: リクエスト
{
    ...
    "equipment": ["diamond_helmet", "diamond_chestplate", null, null, "diamond_sword", null],
...
app.post("/start", (req, res) => {
    ...
    bot.once("spawn", async () => {
        ...
        // const Biome = require("prismarine-biome")(bot.version);
        // const minecraftHawkEye = require("minecrafthawkeye");
        bot.loadPlugin(pathfinder);
        bot.loadPlugin(tool);
        bot.loadPlugin(collectBlock);
        bot.loadPlugin(pvp);
        // bot.loadPlugin(Biome);
        ...
        res.json(bot.observe()); // bot observation
...
app.post("/step", async (req, res) => {
    ...
    //     await camera.takePicture(new Vec3(1, -0.2, 0), `${timestamp}`);
    //     console.log("Screenshot taken after step.");
    // } catch (err) {
